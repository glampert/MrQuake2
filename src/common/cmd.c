...
static qbyte cmd_text_buf[8192];
static qbyte defer_text_buf[8192];
...
void Cbuf_AddText(const char * text)
{
    ...
    SZ_Write(&cmd_text, text, Q_istrlen(text));
}
...
void Cmd_TokenizeString(const char * text, qboolean macroExpand)
{
    ...
    while (1)
    {
        ...
        {
            cmd_argv[cmd_argc] = Z_Malloc(Q_istrlen(com_token) + 1);
