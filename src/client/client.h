...
enum { MAX_CLIENTWEAPONMODELS = 20 }; // PGM -- upped from 16 to fit the chainfist vwep
...
enum { CMD_BACKUP = 64 }; // allow a lot of command backups for very fast systems
