...
==============
*/
void SCR_LoadPCX(char * filename, qbyte ** pic, qbyte ** palette, int * width, int * height)
{
    qbyte * raw;
    pcx_t * pcx;
    int x, y;
...
{
    qbyte samples[22050 / 14 * 4]; // 6.2KB
    qbyte compressed[0x20000];     // 128KB
...
LAMPERT 2015-10-23
Used in combination with CinematicTest_PlayDirect for testing Quake2 cinematics.
It will unconditionally run the next cinematic frame, then draw it to screen.
Must be called inside a BeginFrame/EndFrame loop.
==================
*/
