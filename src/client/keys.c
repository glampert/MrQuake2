...
static const keyname_t keynames[] = {
    ...
    { "CONTROLLER_R2", K_CONTROLLER_R2 },
    { "CONTROLLER_SQUARE", K_CONTROLLER_SQUARE },
    { "CONTROLLER_X", K_CONTROLLER_X },
    { "CONTROLLER_CIRCLE", K_CONTROLLER_CIRCLE },
    { "CONTROLLER_TRIANGLE", K_CONTROLLER_TRIANGLE },
    { "CONTROLLER_DPAD_UP", K_CONTROLLER_DPAD_UP },
    { "CONTROLLER_DPAD_DOWN", K_CONTROLLER_DPAD_DOWN },
    { "CONTROLLER_OPTIONS", K_CONTROLLER_OPTIONS },
    { "CONTROLLER_L3", K_CONTROLLER_L3 },
...
void Key_Console(int key)
{
        ...
        ((key == 'p') && keydown[K_CTRL]))
    {
        ...
        key_linepos = Q_istrlen(key_lines[edit_line]);
        return;
    }
