...
#define EDICT_NUM(n) ((edict_t *)((qbyte *)ge->edicts + ge->edict_size * (n)))
#define NUM_FOR_EDICT(e) (((qbyte *)(e) - (qbyte *)ge->edicts) / ge->edict_size)
...
void SV_ClientPrintf(client_t * cl, print_level_t level, const char * fmt, ...);
void SV_BroadcastPrintf(print_level_t level, const char * fmt, ...);
