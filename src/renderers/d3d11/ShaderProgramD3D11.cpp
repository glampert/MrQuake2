                                      ...
                                      const char * filename, const char * vs_entry, const char * ps_entry, const bool debug)
{
    ...
    static_assert(ArrayLength(d3d_semantic_indices) == VertexInputLayoutD3D11::kElementTypeCount);
    ...
    for (const auto & element : input_layout.elements)
    {
        ...
        input_layout_d3d[num_elements].SemanticIndex        = d3d_semantic_indices[element.type];
